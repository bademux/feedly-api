...
package org.github.bademux.feedly.api.extensions.jetty.auth.oauth2;
 ...
 * @since 1.11
 */
public final class FeedlyLocalServerReceiver implements VerificationCodeReceiver {
   ...
   * </p>
   */
  public FeedlyLocalServerReceiver() {
    this("localhost", -1);
  }
   ...
   */
  FeedlyLocalServerReceiver(String host, int port) {
    this.host = host;
    this.port = port;
  }
  ...
  public static final class Builder {
    ...
    /** Builds the {@link FeedlyLocalServerReceiver}. */
    public FeedlyLocalServerReceiver build() {
      return new FeedlyLocalServerReceiver(host, port);
    }
